...
### Emacs 30+
If you are using Emacs 30+ or prefer using `use-package`, you can install the theme directly from GitHub:
...
Once installed, load the theme by adding the following line to your Emacs init file:
```emacs-lisp
